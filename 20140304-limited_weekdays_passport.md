...
SFC (Sanrio Friendship Club) のポイント交換でピューロランドのチケットを手に入れるのもよいだろう。ただし景品交換の入れ替わりは頻繁の行われるため、今でも交換景品にピューロランドのチケットがあるのかは確認していない。個人的に SMC (Sanrio Members Club) のころと比較すると SFC は交換したい景品が少なく、ポイントが余ってしまっている。ポイントが実質無期限なのも余らせることに拍車をかけているため、SFC のポイント交換でピューロランドのチケットを手に入れる方法もよいだろう。
